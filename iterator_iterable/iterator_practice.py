from itertools import count, cycle, repeat, chain, islice, takewhile, combinations, permutations
...
#   Print all 2-element combinations of:
items = ["A", "B", "C"]

for combo in combinations(items, 2):
    print(combo)

# we have a total of 8 elements:

# 4 are "A"

# 4 are "B"

# If we use all the elements, how many unique arrangements (distinct permutations) can be formed?
items = ["A", "A", "A", "A", "B", "B", "B", "B"]

unique_perms = set(permutations(items))

print(len(unique_perms))  # should print 70
